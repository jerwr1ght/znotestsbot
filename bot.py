...
def welcome(message):
    ...
    if res is None:
        ...
        bot.send_message(message.chat.id, f'Приєднуйтесь до каналу з оновленнями функцій боту та цікавими матеріалами. Від підписників каналу залежить розвиток боту, а нам важлива думка кожного.', reply_markup=link_reply)
        time.sleep(10)
